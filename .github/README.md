...
# INSANE BOT <img src="https://img.shields.io/github/v/release/Akhinkannantg/YukkiMusicBot?color=black&logo=github&logoColor=black&style=social" alt="RELEASE">

[TEAM INSANE](https://github.com/Akhinkannantg/YukkiMusicBot) is a Powerful Telegram Music+Video Bot written in Python using Pyrogram and Py-Tgcalls by which you can stream songs, video and even live streams in your group calls via various sources.
...
### Before deploying INSANE BOT , please have a look towards [all available config vars](../config/README.md) , also please check [all available commands](../strings/command.yml) of the project.
...
Special thanks to these amazing projects/people which/who help power Insane Music Bot:
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Akhinkannantg/YukkiMusicBot)
