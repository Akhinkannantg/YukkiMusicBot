...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/Akhinkannantg/YukkiMusicBot
   ```
...
You've found a bug in the source code, a mistake in the documentation or maybe you'd like a new feature? You can help us by [submitting an issue on GitHub](https://github.com/Akhinkannantg/YukkiMusicBot/issues). Before you create an issue, make sure to search the issue archive -- your issue may have already been addressed!
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/Akhinkannantg/YukkiMusicBot/pulls)
...
6. [Open a Pull Request](https://github.com/Akhinkannantg/YukkiMusicBot/compare?expand=1)
